...
<div class="history">
    <button disabled="{!canUndo}" on:click="{undo}">&laquo; undo</button>
    <button disabled="{!canRedo}" on:click="{redo}">redo &raquo;</button>
    |
    <button on:click="{tasksReorder}">sort</button>
</div>
<ul>
